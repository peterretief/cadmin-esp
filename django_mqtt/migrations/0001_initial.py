# -*- coding: utf-8 -*-
# Generated by Django 1.9.6 on 2016-06-13 08:54
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('only_username', models.NullBooleanField(default=None, help_text='Only valid for connect')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(blank=True, db_index=True, max_length=23, validators=[django_mqtt.validators.ClientIdValidator(valid_empty=False)])),
                ('groups', models.ManyToManyField(blank=True, to='auth.Group')),
